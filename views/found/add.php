            ...
            <div class="panel-body">
                ...
                <form role="form" id="form_lost" method="post" class="form-horizontal" action="">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="type">
                                <option selected="" value="0">招领</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input maxlength="30" placeholder="请输入物品名称或卡号，最多不超过30字" class="form-control" name="title" value="" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id='test1' placeholder="请选择日期" style="cursor:pointer;" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd&#39;, qsEnabled:false, maxDate:&#39;%y-%M-%d&#39;})" class="form-control" name="time" value="" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input placeholder="请输入地点，最多不超过50字" class="form-control" maxlength="50" name="address" value="" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">联系人<span style="color:#f83232"> *</span></label>
                        <div class="col-sm-9">
                            <input placeholder="请输入联系人" class="form-control" maxlength="30" name="name" value="管理员" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">联系电话</label>
                        <div class="col-sm-9">
                            <input placeholder="请输入联系电话" class="form-control" name="tel" value="" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea placeholder="请输入详情备注，最多不超过100字" maxlength="100" class="form-control" name="desc" type="text"></textarea>
                        </div>
                    </div>
                    <!-- 确认 取消 按钮 -->

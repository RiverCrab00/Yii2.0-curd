<!DOCTYPE html>
<!-- saved from url=(0043)http://www.campusapp.com.cn/m_lost/lost/add -->
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/jquery-ui-1.10.4.custom.min.css">
        ...
        <link rel="stylesheet" href="./失物招领添加_files/linecons.css">
        <link rel="stylesheet" href="./失物招领添加_files/font-awesome.min.css">
        <link rel="stylesheet" href="./失物招领添加_files/elusive.css">

        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/bootstrap.min.css">
      ...
      <!--   <link type="text/css" rel="stylesheet" href="http://www.campusapp.com.cn/madmin/style1/vendors/intro.js/introjs.css">
        ...
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/animate.css">
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/pace.css">
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/all.css">
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/jquery.news-ticker.css">
        <!--Loading style-->
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/yellow-blue.css">
        <link type="text/css" rel="stylesheet" href="./失物招领添加_files/style-responsive.css">
        <link rel="stylesheet" href="./失物招领添加_files/data.css">
        <link rel="stylesheet" href="./失物招领添加_files/styles.css">
        <link rel="stylesheet" href="./失物招领添加_files/my-style.css">
        <link rel="stylesheet" href="./失物招领添加_files/alertbox.css">
                            <script type="text/javascript" src="./失物招领添加_files/jquery-1.11.1.min.js.下载"></script>
        <script src="./失物招领添加_files/bootstrap.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/jquery-migrate-1.2.1.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/jquery-ui.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/warnUtil.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/checkUtil.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/plupload.full.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/upload.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/bootstrap-datetimepicker.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/bootstrap-datetimepicker.zh-CN.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/WdatePicker.js.下载"></script><link href="./失物招领添加_files/WdatePicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" charset="utf-8" src="./失物招领添加_files/ueditor.config.js.下载"></script>
        <script type="text/javascript" charset="utf-8" src="./失物招领添加_files/ueditor.all.min.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/jquery.md5.js.下载"></script>
        <script type="text/javascript" src="./失物招领添加_files/baiduTemplate.js.下载"></script>
        ...
        <div class="navbar-header">
            ...
            <a id="logo" href="http://www.campusapp.com.cn/" class="navbar-brand" style="padding: 8px;">
                <span class="fa fa-rocket"></span>
                                <span class="logo-text"><img src="./失物招领添加_files/sdtech-logo-white.png"></span>
        ...
        <div class="topbar-main"><a id="menu-toggle" href="javascript:void(0)" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <li class="dropdown topbar-user">
                    <a data-hover="dropdown" href="javascript:void(0);" class="dropdown-toggle">
                        <img src="./失物招领添加_files/205106085.jpg" alt="头像" class="img-responsive img-circle">&nbsp;
    ...
    <div class="sidebar-collapse menu-scroll" style="height: auto;">
        <ul id="side-menu" class="nav">
            <li class="user-panel">
                    ...
                    <div class="thumb">
                        <img src="./失物招领添加_files/205106085.jpg" alt="头像" class="img-circle">
                    </div>
                    <div class="info">
                        <p>戴游宇</p>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">发　布</h3>
            </div>

            <div class="panel-body">

                <form role="form" id="form_lost" method="post" class="form-horizontal" action="">
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">发布类型</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="type">
                                <option <?php echo $data['type']==0?'selected':'' ?> value="0">招领</option>
                                <option value="1" <?php echo $data['type']==1?'selected':'' ?>>寻物</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">物品类型<span style="color:#f83232"> *</span></label>
                        <div class="col-sm-9">
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="一卡通"></div><div class="cbr-state"><span></span></div></div>一卡通                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="生活用品"></div><div class="cbr-state"><span></span></div></div>生活用品                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="电脑"></div><div class="cbr-state"><span></span></div></div>电脑                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="手机"></div><div class="cbr-state"><span></span></div></div>手机                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="钥匙"></div><div class="cbr-state"><span></span></div></div>钥匙                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="钱包"></div><div class="cbr-state"><span></span></div></div>钱包                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="卡类"></div><div class="cbr-state"><span></span></div></div>卡类                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="证件"></div><div class="cbr-state"><span></span></div></div>证件                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="书籍"></div><div class="cbr-state"><span></span></div></div>书籍                            </label>
                                                        <label style="margin-right:10px;">
                                <div class="cbr-replaced cbr-radio"><div class="cbr-input"><input class="cbr cbr-done" type="radio" name="tag" value="其他"></div><div class="cbr-state"><span></span></div></div>其他                            </label>
                                                    </div>
                    </div>
                    <div class="form-group">
                        <label id="title_lable" class="col-sm-2 control-label t-r" for="">物品名称<span style="color:#f83232"> *</span></label>

                        <div class="col-sm-9">
                            <input maxlength="30" placeholder="请输入物品名称或卡号，最多不超过30字" class="form-control" name="title" value="<?php echo $data['title']?>" type="text">
                        </div>
                    </div>
                    <div class="form-group" style="position: relative;">
                        <label class="col-sm-2 control-label t-r" for="">物品图片<span style="color:#f83232"> *</span></label>
                        <button type="button" id="image_select_file" class="btn btn-warning btn-single" style="float: left; margin-left: 15px; position: relative; z-index: 1;">
                            <i class="fa-upload"></i>
                            <span>选择图片</span>
                        </button>
                        <div class="col-sm-10 col-sm-offset-2" id="image_select_pic_box">
                                                    </div>
                        <input type="hidden" name="image" value="">
                    <div id="html5_1brvijge81mvjjc61nm9ogv1eiv3_container" class="moxie-shim moxie-shim-html5" style="position: absolute; top: 0px; left: 226px; width: 90px; height: 33px; overflow: hidden; z-index: 0;"><input id="html5_1brvijge81mvjjc61nm9ogv1eiv3" type="file" style="font-size: 999px; opacity: 0; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;" accept="image/bmp,image/png,image/jpeg,image/gif"></div></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for=""><span class="can_change_text">拾取</span>日期<span style="color:#f83232"> *</span></label>

                        <div class="col-sm-9">
                            <input id='test1' placeholder="请选择日期" style="cursor:pointer;" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd&#39;, qsEnabled:false, maxDate:&#39;%y-%M-%d&#39;})" class="form-control" name="time" value="<?php echo date('Y-m-d',$data['pickupTime'])?>" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for=""><span class="can_change_text">拾取</span>地点<span style="color:#f83232"> *</span></label>

                        <div class="col-sm-9">
                            <input placeholder="请输入地点，最多不超过50字" class="form-control" maxlength="50" name="address" value="<?php echo $data['address']?>" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">联系人<span style="color:#f83232"> *</span></label>
                        <div class="col-sm-9">
                            <input placeholder="请输入联系人" class="form-control" maxlength="30" name="name" value="<?php echo $data['name']?>" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">联系电话</label>
                        <div class="col-sm-9">
                            <input placeholder="请输入联系电话" class="form-control" name="tel" value="<?php echo $data['tel']?>" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label t-r" for="">详情备注</label>

                        <div class="col-sm-9">
                            <textarea placeholder="请输入详情备注，最多不超过100字" maxlength="100" class="form-control" name="desc" type="text"><?php echo $data['description']?></textarea>
                        </div>
                    </div>
                    <!-- 确认 取消 按钮 -->
                    <div id="confirm" class="form-group savegroup">
                        <input type="hidden" name="id" value="<?php echo $data['id']?>">
                        <a type="submit" class="btn btn-success btn-width">保存</a>
                        <button>提交</button>
                        <a type="button" class="btn btn-gray btn-width" onclick="Javascript:window.history.go(-1)">取消</a>
...
<script src="./失物招领添加_files/bootstrap-hover-dropdown.js.下载"></script>
<script src="./失物招领添加_files/html5shiv.js.下载"></script>
<script src="./失物招领添加_files/respond.min.js.下载"></script>
<script src="./失物招领添加_files/jquery.metisMenu.js.下载"></script>
<script src="./失物招领添加_files/jquery.slimscroll.js.下载"></script>
<script src="./失物招领添加_files/jquery.cookie.js.下载"></script>
<script src="./失物招领添加_files/jquery.menu.js.下载"></script>
<script src="./失物招领添加_files/pace.min.js.下载"></script>
<script src="./失物招领添加_files/holder.js.下载"></script>
<script src="./失物招领添加_files/responsive-tabs.js.下载"></script>

<script src="./失物招领添加_files/intro.js.下载"></script>
...
<script src="./失物招领添加_files/index.js.下载"></script>

<script type="text/javascript" src="./失物招领添加_files/keywords.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/face.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/jquery.selectBoxIt.min.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/alert-fade.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/alert-box.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/jquery.lazyload.js.下载"></script>
<script src="./失物招领添加_files/main.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/xenon-custom.js.下载"></script>
<script type="text/javascript" src="./失物招领添加_files/vue.min.js.下载"></script>
        <script id="imgTemplate" type="text/html">
    <img url="<%=url%>" style="max-width:150px; height:144px; margin-top: 10px;" class="vote-img" id="head_pic_preview" src="http://img.campusapp.com.cn/<%=url%>">
    <a onclick="mpUtil.setImage(this)" style="vertical-align: bottom; cursor:pointer" href="javascript:;">删除</a>
</script>
  ...
  elem: '#test1' //指定元素
    ...
    $(function(){
        $('select[name=type]').change(function(){
            if($(this).val() == 0){
                $('span.can_change_text').text('拾取');
            }else{
                $('span.can_change_text').text('遗失');
            }
        });
        $(':radio[name=tag]').change(function(){
            if($(this).val() == '一卡通'){
                mpUtil.titLabel = '一卡通卡号';
            }else{
                mpUtil.titLabel = '物品名称';
            }
            $('#title_lable').text( mpUtil.titLabel);
        });
    });
    var optionBanner = {
        selectObj:'image_select_file',
        autoUpload:true,
        multipartParams:{'category':'image'}, //category:image 图片 document 文档  media 媒体
        onUploadComplete: function(args){
            args = eval("("+args+")");
            var html = baidu.template('imgTemplate',args);
            $('#image_select_pic_box').append(html);
            $('#image_select_pic_box').show();
            mpUtil.imgs = [];
            $('#image_select_pic_box').find('img').each(function(){
                if(mpUtil.imgs.length<2){
                    mpUtil.imgs.push($(this).attr('url'));
                }else{
                    $('#image_select_file').hide();
                }
            });
            $('input[name=image]').val(mpUtil.imgs.join(','));
        },
    };
    uploadUtil.init(optionBanner);
    var mpUtil = {
        saveUrl: '/m_lost/lost/save',
        saveLock: false,
        titLabel: '物品名称',
        save: function ()
        {
            var checkTitle = checkUtil.checkEmpty('title',this.titLabel);
            var checkTag = checkUtil.checkRadio('tag','物品类别');
            var checkAddr = checkUtil.checkEmpty('address','地点');
            var checkImage = checkUtil.checkEmpty('image','图片');
            var checkTime = checkUtil.checkEmpty('time','日期');
            var checkName = checkUtil.checkEmpty('name','联系人');
            var checkTel = true;
            var tel = $('input[name=tel]').val();
            if($.trim(tel) != "" && !this.checkTel(tel)){
                warnUtil.setWrong($('input[name=tel]'),'请填写正确的联系方式');
                checkTel = false;
            }else{
                warnUtil.setRight($('input[name=tel]'));
                checkTel = true;
            }
            
            if(!(checkTitle && checkTag && checkAddr && checkImage && checkTime && checkName && checkTel))
            {
                return false;
            }
            ...
            $.ajax({
                ...
                cache: false,
                url: this.saveUrl,
                data: $("#form_lost").serialize(),
                dataType: 'json',
                success: function (resp) {
                    if (resp.e === '9999')
                    {
                        alertbox(resp.m, 1, 2000);
                        setTimeout(function () {
                            window.location = "/m_lost/lost/index";
                        }, 2000);
                    } else
                    {
                        alertbox(resp.m, 2, 2000);
                        mpUtil.saveLock = false;
                    }
                },
                error: function() 
                {
                    alertbox("未知错误，请稍候重试",2,1500);
                    mpUtil.saveLock = false;
                }
            });
        },
        setImage: function(obj){
            ...
            $(obj).remove();
            mpUtil.imgs = [];
            $('#image_select_file').show();
            $('#image_select_pic_box').find('img').each(function(){
                if(mpUtil.imgs.length<3){
                    mpUtil.imgs.push($(this).attr('url'));
                }else{
                    $('#image_select_file').hide();
                }
        ...
        {
            var mobile = /^1[34578]\d{9}$/, phone = /^([0-9]{3,4}-)?[0-9]{7,8}$/;
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 186px; height: 198px;" src="./失物招领添加_files/My97DatePicker.html" frameborder="0" border="0" scrolling="no"></iframe></div></body></html>